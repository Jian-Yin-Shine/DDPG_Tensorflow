...
class DDPG:
    def __init__(self, obs_dim, action_dim, action_gain, actor_learning_rate=0.0001, critic_learning_rate=0.001, gamma=0.99, tau=0.001):
    ...
    def update_target(self, main_model, target_model):
        ...
        for model_weight, target_weight in zip(main_model.weights, target_model.weights):
